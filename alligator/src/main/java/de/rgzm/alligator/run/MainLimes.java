...
public class MainLimes {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        try {
            ...
            // read file
            File fileDir = new File("../data/limes.tsv");
            ...
            // write timeline json
            Timeline.writeTimeline("output_Limes.json", alligator);
            // allen
            alligator.calculateAllenSigns();
            Graph.writeGraph("nodesedges_Limes.json", alligator);
            RDFEvents.writeRDF("Limes.ttl", alligator);

            // write distance matrix
            File file = new File("../matrix/Limes_distanceMatrix.txt");
            ...
            // write allen matrix
            file = new File("../matrix/Limes_allenMatrix.txt");
